    ...
    return (
        <div id="honors" className="mt-4 text-white">
            ...
            <p style={{ display: "none" }}>
                https://play.google.com/store/apps/details?id=com.goodgrid.clientcompanion&hl=en&gl=US

                https://play.google.com/store/apps/details?id=com.imateam.us&hl=en&gl=US

                http://www.ktlink.co.kr/
            </p>
